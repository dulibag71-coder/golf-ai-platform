...
export default function LeaderboardPage() {
    ...
    const leaderboardData: LeaderboardEntry[] = [
        { rank: 1, id: '1', name: '김프로', team: '드래곤즈', avgScore: 94, totalAnalyses: 156, improvement: 8.5, country: 'KR', avatar: '👑' },
        { rank: 2, id: '2', name: '이마스터', team: '이글스', avgScore: 92, totalAnalyses: 142, improvement: 5.2, country: 'KR', avatar: '🏌️' },
        { rank: 3, id: '3', name: 'Tiger Park', team: 'Global Pro', avgScore: 91, totalAnalyses: 189, improvement: 3.8, country: 'US', avatar: '🐯' },
        { rank: 4, id: '4', name: '박세리', team: '피닉스', avgScore: 89, totalAnalyses: 134, improvement: 6.1, country: 'KR', avatar: '⛳' },
        { rank: 5, id: '5', name: 'John Smith', team: 'Euro Masters', avgScore: 88, totalAnalyses: 98, improvement: -1.2, country: 'GB', avatar: '🎯' },
        { rank: 6, id: '6', name: '최루키', team: '드래곤즈', avgScore: 86, totalAnalyses: 78, improvement: 12.3, country: 'KR', avatar: '🔥' },
        { rank: 7, id: '7', name: '정멤버', team: '이글스', avgScore: 85, totalAnalyses: 112, improvement: 2.1, country: 'KR', avatar: '🏆' },
        { rank: 8, id: '8', name: 'Maria Garcia', team: 'Latin Golf', avgScore: 84, totalAnalyses: 67, improvement: 4.5, country: 'ES', avatar: '💪' },
        { rank: 9, id: '9', name: '한선수', team: '피닉스', avgScore: 83, totalAnalyses: 89, improvement: 0.0, country: 'KR', avatar: '🎖️' },
        { rank: 10, id: '10', name: '윤캡틴', team: '드래곤즈', avgScore: 82, totalAnalyses: 145, improvement: -0.5, country: 'KR', avatar: '⭐' },
    ];
